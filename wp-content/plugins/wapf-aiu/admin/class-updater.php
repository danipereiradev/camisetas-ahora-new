...
namespace SW_WAPFAIU\Admin {
    ...
    class Updater
    {
        ...
        public function __construct() {
            ...
            $this->slug        = 'wapf-aiu';
            $this->version     = WAPFAIU_VERSION;
            $this->name        = plugin_basename( WAPFAIU_STARTFILE );
        ...
        public function in_plugin_update_message($args, $response) {
	        if($this->get_key() === false || empty( $response->package ))
		        echo  '<br/>' . __('Updates are disabled because your license key is expired. To enable updates, please renew your license key.', 'wapf-aiu');
        ...
        public static function get_license_info() {
            $raw = get_option( 'wapf-aiu_license' );
        ...
        public function deactivate_license()
        {
            ...
            delete_option('wapf-aiu_license');
        ...
        {
            $key = $_POST['wapfaiu_license'];

			if(empty($key)) return "Please enter a valid license key.";
            ...
            update_option('wapf-aiu_license', base64_encode(json_encode(
                [
                    'key' => $key,
        ...
        public function set_version_info_cache( $value ) {
            ...
            set_transient($this->slug .'_version_info', json_encode($value), HOUR_IN_SECONDS * 24 ); // Store for 10 hours.
