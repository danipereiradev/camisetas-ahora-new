...
namespace SW_WAPFLCP\Admin {
    ...
    class Updater
    {
        ...
        public function __construct() {
            ...
            $this->slug        = 'wapf-lcp';
            $this->version     = WAPFLCP_VERSION;
            $this->name        = plugin_basename( WAPFLCP_STARTFILE );
        ...
        public static function get_license_info() {
            $raw = get_option( 'wapf-lcp_license' );
        ...
        public function deactivate_license()
        {
            ...
            delete_option('wapf-lcp_license');
        ...
        public function activate_license()
        {
            ...
            update_option('wapf-lcp_license', base64_encode(json_encode(
                [
                    'key' => $key,
